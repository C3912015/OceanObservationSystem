...
<html>
	...
	<?php else:?>
        ...
        <?php if($_SESSION['role']=='a'):?>
	    	...
	    	<a href = "usermanagementIn.php"> User Management</a> <br>
	 		<a href = "sensorManagementIn.php"> Sensor Management</a> </p>
        <?php endif;?>
        ...
        <?php if($_SESSION['role']=='s'):?>
        	<a href="subscribe.php"> View Subscriptions</a> <br/>
			<a href="data-analysis.php"> Data Analysis</a> <br/><br/>
        <?php endif;?>
